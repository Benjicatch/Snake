...
Snake::AViewDisplay::AViewDisplay(Snake::AViewDisplay &view) : _window(view._window), _status(view._status), _window_map(view._window_map), _map(view._map), _backg(view._backg)
{
}
